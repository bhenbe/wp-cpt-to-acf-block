...
function block_global_custom_post_type() {

	// On rentre les différentes dénominations de notre custom post type qui seront affichées dans l'administration
	$labels = array(
		// Le nom au pluriel
		'name'                => _x( 'Blocs de contenu global', 'Post Type General Name'),
		// Le nom au singulier
		'singular_name'       => _x( 'Bloc de contenu global', 'Post Type Singular Name'),
		// Le libellé affiché dans le menu
		'menu_name'           => __( 'Blocs de contenu global'),
		// Les différents libellés de l'administration
		'all_items'           => __( 'Tous les blocs de contenu global'),
		'view_item'           => __( 'Voir les blocs de contenu global'),
		'add_new_item'        => __( 'Ajouter un nouveau bloc de contenu global'),
		'add_new'             => __( 'Ajouter'),
		'edit_item'           => __( 'Editer le bloc de contenu global'),
		'update_item'         => __( 'Modifier le bloc de contenu de global'),
		'search_items'        => __( 'Rechercher un bloc de contenu global'),
	...
	$args = array(
		'label'               => __( 'Blocs de contenu global'),
		'description'         => __( 'Tous sur les blocs de contenu global'),
		'labels'              => $labels,
		...
		*/
		...
		'public'              => true,
		'has_archive'         => true,
		'rewrite'			  => array( 'slug' => 'block-global'),

	);
	
	// On enregistre notre custom post type qu'on nomme ici "serietv" et ses arguments
	register_post_type( 'blockglobal', $args );

}

add_action( 'init', 'block_global_custom_post_type', 0 );
...
function my_acf_init() {
	...
	if( function_exists('acf_register_block') ) {
		...
		acf_register_block(array(
			'name'				=> 'blockglobal',
			'title'				=> __('Bloc de contenu global'),
			'description'		=> __('A global content block.'),
			'render_callback'	=> 'my_acf_block_render_callback',
			'category'			=> 'formatting',
			'icon'				=> 'admin-comments',
			'keywords'			=> array( 'block', 'content', 'global' ),
		));
	}
}
...
function my_acf_block_render_callback( $block ) {
	...
	if( file_exists( get_theme_file_path("/template-parts/block/content-block-global.php") ) ) {
		include( get_theme_file_path("/template-parts/block/content-block-global.php") );
	}
}